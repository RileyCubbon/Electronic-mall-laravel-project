...
<div class="sidebar-nav">
    ...
    <ul id="error-menu" class="nav nav-list collapse">
        <li><a href="{{ route('managers.index') }}">管理员列表</a></li>
        <li><a href="{{ route('managers.create') }}">管理员新增</a></li>
        <li><a href="#">角色管理</a></li>
        <li><a href="javascript:void(0);">权限管理</a></li>
    </ul>
...
<![endif]-->
<script src="{{ asset('admin/js/jquery181.js') }}"></script>
<script src="{{ asset('share/js/app.js') }}"></script>
